...
# Configure page
st.set_page_config(
    page_title="CSTU Startup Center - Cupertino Stories AI-Generator",
    page_icon="✍️",
    layout="wide",
    ...
    with st.sidebar:
        st.markdown("""
            ...
            [data-testid="stSidebar"] {
                background-color: #E2FFAF !important; 
            }
            .sidebar-text {
        ...
        st.markdown("<font color='darkblue'><b><p style='font-size: 20px; text-align: center; '>CSTU Startup Center</p></b></font>", unsafe_allow_html=True)        
        st.image("StoryGenIcon.png", width=300)
        st.markdown("<font color='darkblue'><b><p style='font-size: 20px; text-align: center; '>CUPERTINO STORIES AI-GENERATOR</p></b></font>", unsafe_allow_html=True)
